...
--
-- Host: 127.0.0.1
-- Tempo de geração: 29/11/2023 às 14:16
...
(6, 'Leg 45', 'homem-se-preparando-pra-fazer-', 'leg ', 5);
...
--
-- Despejando dados para a tabela `exercicio_treino`
--
...
(228, 88, 1, 4, 3, 12, '50kg', '1min'),
(229, 88, 2, 5, 3, 10, '110kg', '2min'),
(230, 88, 2, 4, 4, 10, '40kg', '40s'),
(231, 88, 2, 6, 4, 10, '200kg', '2min'),
(232, 89, 1, 5, 3, 12, '100kg', '1min'),
(233, 90, 0, 5, 1, 1, '1', '1'),
(234, 90, 0, 6, 2, 2, '2', '2'),
(235, 90, 0, 4, 3, 3, '3', '3'),
(236, 91, 0, 5, 1, 1, '1', '1'),
...
--
-- Estrutura para tabela `ficha_treino`
--
...
--
-- Despejando dados para a tabela `ficha_treino`
--

INSERT INTO `ficha_treino` (`id`, `nome`, `aluno_id`, `personal_id`, `num_treinos`, `descricao`, `dataCadastro`) VALUES
(87, 'Hipertrofia', 9, NULL, 2, 'teste', '2023-11-23 10:21:36'),
(88, 'Hipertrofia', 9, 6, 2, 'teste', '2023-11-23 10:25:52'),
(89, 'Perna', 10, 2, 1, 'teste', '2023-11-23 10:32:45'),
(90, 'Olimpia', 17, 6, 2, 'teste', '2023-11-24 11:29:06'),
(91, 'Olimpia', 17, 6, 2, 'teste', '2023-11-24 11:29:31'),
(92, 'Olimpia', 17, 6, 2, 'teste', '2023-11-24 11:30:37'),
(93, 'Olimpia', 17, 6, 2, 'teste', '2023-11-24 11:30:50'),
(94, 'Olimpia', 17, 6, 2, 'teste', '2023-11-24 11:31:26'),
(95, 'Olimpia Win', 9, 6, 2, 'ae', '2023-11-24 11:43:49'),
(96, 'Olimpia Win', 9, 6, 2, 'ae', '2023-11-24 11:46:32'),
(99, 'chegaa', 1, 6, 2, 'a', '2023-11-24 12:00:46'),
(102, 'Aeróbico Teste', 9, 6, 2, 'teste de treino', '2023-11-29 09:08:00'),
(103, 'Hipertrofia', 9, 6, 2, 'afa', '2023-11-29 09:59:09');
...
--
-- Despejando dados para a tabela `grupomuscular`
--
...
--
-- Índices de tabela `ficha_treino`
--
...
--
-- Restrições para tabelas `ficha_treino`
--
ALTER TABLE `ficha_treino`
  ADD CONSTRAINT `fk_ficha_treino_aluno` FOREIGN KEY (`aluno_id`) REFERENCES `aluno` (`id`),
  ADD CONSTRAINT `fk_ficha_treino_personal` FOREIGN KEY (`personal_id`) REFERENCES `personal` (`id`);
COMMIT;
