                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form>
                                ...
                                <div class="row mb-3">
                                    <label for="descricao" class="col-sm-2 col-form-label">Descrição:<span
                                            class="campo-obrigatorio">*</span></label>
                                    <div class="col-sm-10">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" id="numSeries" name="numSeries" class="form-control"
                                            required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="numRepeticoes" class="col-sm-2 col-form-label">Quantidade de
                                        Repetições</label>
                                    <div class="col-sm-10">
                                        <input type="number" id="numRepeticoes" name="numRepeticoes"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="descanso" name="tempoDescanso" class="form-control"
                                            required>
                                    </div>
                                </div>
