...
$personal_name = isset($_SESSION['nome']) ? $_SESSION['nome'] : 'Nome Padrão'; // Corrigido de $_SESSION['admin_name'] para $_SESSION['nome']
$personal_role = isset($_SESSION['email']) ? $_SESSION['email'] : 'Email Padrão'; // Corrigido de $_SESSION['admin_role'] para $_SESSION['email']
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="homePersonal.php" class="logo d-flex align-items-center">
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="mostrarPerfilPersonal.php">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="mostrarPerfilPersonal.php?action=edit-profile">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="homePersonal.php">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="listarFichaTreinoPersonal.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="mostrarPerfilPersonal.php">
          <i class="bi bi-person"></i>
          <span>Perfil</span>
        </a>
