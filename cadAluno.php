...
if (isset($_POST['salvar'])) {
    ...
    if ($cpf === null || $email === null) {
        ...
        if (!validarCPF($cpf)) {
            ...
            $sqlVerificacao = "SELECT COUNT(*) as total FROM aluno WHERE cpf = '$cpf' OR email = '$email'";
            ...
            if ($rowVerificacao['total'] > 0) {
                ...
                if (mysqli_query($conexao, $sql)) {
                    ...
                    header("Location: cadAluno.php?mensagem=" . urlencode($mensagem));
...
<head>
    ...
    <link rel="stylesheet" href="http://www.jsdelivr.com/projects/jquery.mask">
                            ...
                            <form action="cadAluno.php" method="post">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <label for="nr_end" class="col-sm-1 col-form-label">Número:<span
                                            class="campo-obrigatorio">*</span></label>
                                    <div class="col-sm-4">
                                        <input type="text" id="nr_end" name="numero" class="form-control" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
