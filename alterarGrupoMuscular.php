...
//Bucar usuário selecionado pelo "listarGrupoMuscular.php"
$sql = "select * from grupomuscular where id = " . $_GET['id'];
...
<head>
    ...
    <title>Alteração de Grupo Muscular</title>
                ...
                <div class="col-lg-10">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="alterarGrupoMuscular.php?id=<?= $_GET['id'] ?>" method="post"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" id="descricao" name="descricao"
                                            style="height: 100px"><?= $linha['descricao'] ?></textarea>
                                    </div>
                                </div>
