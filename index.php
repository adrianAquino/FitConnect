...
if (isset($_SESSION['mensagemErro'])) {
  ...
  unset($_SESSION['mensagemErro']); // Limpar a mensagem da sessão
}
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form method="post" action="autenticacao.php" class="row g-3 needs-validation" novalidate>

                    <div class="col-12">
                      <label for="email" class="form-label">Email:<span class="campo-obrigatorio">*</span></label>
